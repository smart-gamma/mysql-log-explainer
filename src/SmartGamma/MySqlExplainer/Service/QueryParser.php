...
class QueryParser
{
    ...
    public function parseQueries(): array
    {
        ...
        $queries[] = 'SELECT * FROM faq_question f0_ INNER JOIN user_questions u2_ ON f0_.id = u2_.question_id INNER JOIN fos_user_user f1_ ON f1_.id = u2_.user_id WHERE f1_.id IN (73) ORDER BY f0_.id ASC LIMIT 32';
